...
@section('content')
    {!! Form::open(['url' => route('councilCreate',app()->getLocale()),'method' =>'post','files'=>true]) !!}
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div
                                    ...
                                    {{ Form::text('first_name', '', ['class' => 'form-control', 'no','placeholder'=>__('admin.enter_first_name')]) }}
                            ...
                            <div class="col-6">
                                <div
                                    ...
                                    {{ Form::text('last_name', '', ['class' => 'form-control', 'no','placeholder'=>__('admin.enter_last_name')]) }}
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div
                                    ...
                                    {{ Form::email('email', '', ['class' => 'form-control', 'no','placeholder'=>__('admin.enter_email')]) }}
                                    @if ($errors->has('email'))
                                        <span class="help-block">
                                    {{ $errors->first('email') }}
                                </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div
                                    ...
                                    {{ Form::text('phone', '', ['class' => 'form-control', 'no','placeholder'=>__('admin.enter_phone')]) }}
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
                                    {{ $errors->first('phone') }}
                                </span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    {{ Form::textarea('biography', '', ['id'=>'article-ckeditor','class' => 'form-control', 'no','placeholder'=>__('admin.enter_biography')]) }}
