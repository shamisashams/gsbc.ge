                        ...
                        <div class="row">
                            <div class="col-6">
                                <div
                                    ...
                                    {{ Form::text('title', (count($news->availableLanguage) > 0) ? $news->availableLanguage[0]->title : '', ['class' => 'form-control', 'no','placeholder'=> __('admin.enter_title')]) }}
                                    @if ($errors->has('title'))
                            ...
                            <div class="col-6">
                                <div
                                    ...
                                    {{ Form::text('description', (count($news->availableLanguage) > 0) ? $news->availableLanguage[0]->description : '', ['class' => 'form-control', 'no','placeholder'=> __('admin.enter_description')]) }}
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div
                                    ...
                                    {{ Form::text('slug', $news->slug, ['class' => 'form-control', 'no','placeholder'=> __('admin.enter_slug')]) }}
                                    @if ($errors->has('slug'))
                                        <span class="help-block">
                                    {{ $errors->first('slug') }}
                                </span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    {{ Form::textarea('body', (count($news->availableLanguage) > 0) ? $news->availableLanguage[0]->body : '', ['id'=>'article-ckeditor','class' => 'form-control', 'no','placeholder'=> __('admin.enter_body')]) }}
                                    @if ($errors->has('body'))
                                        <span class="help-block">
                                    {{ $errors->first('body') }}
                                </span>
